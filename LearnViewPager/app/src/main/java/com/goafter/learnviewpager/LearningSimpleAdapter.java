...
public class LearningSimpleAdapter extends ListActivity {
    ...
    private List<Map<String, Object>> getData() {
        ...
        map.put("img", R.drawable.face_default);
        list.add(map);

        map = new HashMap<String, Object>();
        map.put("title", "G2");
        map.put("info", "google 2");
        map.put("img", R.drawable.face_low);
        list.add(map);

        map = new HashMap<String, Object>();
        map.put("title", "G3");
        map.put("info", "google 3");
        map.put("img", R.drawable.face_high);
        list.add(map);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_learning_simple_adapter, menu);
        return true;
    }
