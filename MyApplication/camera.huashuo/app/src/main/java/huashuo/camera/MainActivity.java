...
public class MainActivity extends Activity implements SurfaceHolder.Callback,Camera.PictureCallback{
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        camera = Camera.open(); //获取Camera实例 0前置，1后置
        int number  = Camera.getNumberOfCameras();
        Log.e("RYC","The Number of camera: " + number);
        ...
        try {
            ...
            //surfaceView.setLayoutParams(new LinearLayout.LayoutParams(640,480));
